...
class Quik_Theme_Dual_Heading extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Dual Heading', 'quik-theme-addons' );
	}
    ...
    public function get_keywords() {
        return [ 'quik-theme-addons', 'multi', 'double', 'heading' ];
    }
    ...
    protected function _register_controls() {
		...
		*/
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'Before Heading', 'quik-theme-addons' ),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => esc_html__( 'Before', 'quik-theme-addons' ),
                'dynamic'     => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'Middle Heading', 'quik-theme-addons' ),
                'type'        => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default'     => esc_html__( 'Middle', 'quik-theme-addons' ),
                'dynamic'     => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'Enable After Heading', 'quik-theme-addons' ),
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__( 'After Heading', 'quik-theme-addons' ),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => esc_html__( 'After', 'quik-theme-addons' ),
                'dynamic'     => [
                    'active' => true,
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'       => __( 'Heading URL', 'quik-theme-addons' ),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'Enable Sub Heading', 'quik-theme-addons' ),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'no',
                'return_value' => 'yes'
            ]
        ...
        $this->add_control(
            ...
            [
                'label'       => __( 'Sub Heading', 'quik-theme-addons' ),
                'type'        => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'dynamic'     => [ 'active' => true ],
                'condition' => [
                ...
                'default'     => __( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 'quik-theme-addons' )
            ]
        );
        ...
        */
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'General Styles', 'quik-theme-addons' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'       => esc_html__( 'Alignment', 'quik-theme-addons' ),
                'type'        => Controls_Manager::CHOOSE,
                'toggle'      => false,
                'label_block' => true,
                'options'     => [
                    'left'      => [
                        'title' => esc_html__( 'Left', 'quik-theme-addons' ),
                        'icon'  => 'eicon-text-align-left'
                    ],
                    'center'    => [
                        'title' => esc_html__( 'Center', 'quik-theme-addons' ),
                        'icon'  => 'eicon-text-align-center'
                    ],
                    'right'     => [
                        'title' => esc_html__( 'Right', 'quik-theme-addons' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Strok Fill Color', 'quik-theme-addons' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Strok Color', 'quik-theme-addons' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => __( 'Strok Width', 'quik-theme-addons' ),
        ...
        */
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Sub Heading', 'quik-theme-addons' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'quik_theme_addons_sub_headding_show' => 'yes',
                ],
