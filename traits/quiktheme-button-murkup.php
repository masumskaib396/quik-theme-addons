...
trait Button_Markup {
    ...
    public function render_estilo_markup($settings) {
        $this->add_render_attribute( 'wrap', 'class', 'quiktheme-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'quiktheme-creative-btn', 'quiktheme-stl--' . $settings['btn_style'], 'quiktheme-eft--' .$settings['estilo_effect'] ] );
...
EOF;
    ...
    public function render_symbolab_markup($settings){
        $this->add_render_attribute( 'wrap', 'class', 'quiktheme-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'quiktheme-creative-btn', 'quiktheme-stl--' . $settings['btn_style'], 'quiktheme-eft--' .$settings['symbolab_effect'] ] );
...
EOF;
    ...
    public function render_iconica_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'quiktheme-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'quiktheme-creative-btn', 'quiktheme-stl--' . $settings['btn_style'], 'quiktheme-eft--' .$settings['iconica_effect'] ] );
...
EOF;
    ...
    public function render_montino_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'quiktheme-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'quiktheme-creative-btn', 'quiktheme-stl--' . $settings['btn_style'], 'quiktheme-eft--' .$settings['montino_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
...
EOF;
    ...
    public function render_hermosa_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'quiktheme-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'quiktheme-creative-btn', 'quiktheme-stl--' . $settings['btn_style'], 'quiktheme-eft--' .$settings['hermosa_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
