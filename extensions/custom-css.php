	...
	public function quik_theme_add_section_custom_css_controls($widget, $section_id, $args)
	{
		...
		if (!defined('ELEMENTOR_PRO_VERSION')) {
			...
			$widget->start_controls_section(
				...
				array(
					'label'     => __('Custom CSS by Quiktheme', 'quik-theme-addons'),
			...
			$widget->add_control(
				...
				array(
					...
					'label'       => __('Custom CSS', 'quik-theme-addons'),
					'label_block' => true,
					'language'    => 'css'
				)
			);
...
selector .child-element{ margin: 10px; }
			...
			$widget->add_control(
				...
				array(
					'raw'             => __('Use "selector" keyword to target wrapper element.', 'quik-theme-addons') . $output,
